/**
 * Responsive Framework - version: 0.6.0 Date: 2013-01-29
 * Copyright (c) 2006-2013  CoffeeCup Software, Inc. (http://www.coffeecup.com/)
 */
...
(function($){
	$(document).ready(function(){
		...
		{
		  $(document).on('click', 'ul > .has-flyout > a', function(e)
		  {
		...
		if ( $('iframe', parent.document).html() !== undefined ) {
		  $('li.has-flyout').die("mouseenter");
		  $('li.has-flyout').die("mouseleave");
		}
