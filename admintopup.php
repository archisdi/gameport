        ...
        <div id="menuBuilderContainer">
            <div id="menuBuilder">
                ...
                <div id="nav" class="nav">
                    ...
                    <form class="fb-toplabel fb-100-item-column selected-object" id="docContainer" action="do_addgame.php" enctype="multipart/form-data" method="post" novalidate="novalidate"data-form="preview">
                        ...
                        <div class="section" id="section1">
                            <div class="column ui-sortable" id="column1">
                                ...
                                <div class="fb-item fb-100-item-column" id="item2">
                                    <?php
                                    $call_all_data = $connect->query("SELECT * FROM topup where status = 'Request'");
                                    ...
                                    while ($fetch_all_data = $call_all_data->fetch_assoc()) {
                                        ...
                                        echo "<td>Bank Tujuan     : " . $fetch_all_data["bank"] . "<br></td>";
                                        echo "<td>Tangal Transfer : " . $fetch_all_data["tanggal"] . "  " . $fetch_all_data["waktu"] . "<br></td>";
                                        echo "<td>No.rek Pengirim : " . $fetch_all_data["norek"] . "<br></td>";
                                        echo "<td>Cara Transfer   : " . $fetch_all_data["transfer"] . "<br></td>";
                                        echo "<td>Berita          : " . $fetch_all_data["berita"] . "<br></td>";
                                        echo "<td>Jumlah          : RP. " . $fetch_all_data["total"] . "<br><br></td>";
                                        echo "<td><a href='do_admintopup.php?profile=" . $fetch_all_data["idUser"] . "'>Confirm top up</a></td>";
                                        echo '&nbsp-&nbsp';
                                        echo "<td><a href='declinetopup.php?profile=" . $fetch_all_data["idUser"] . "'>Decline top up</a><br><br><br></td>";
                                        echo "</tr>";
                                    }
                                    }else{
                                        echo 'No top up request';
                                        echo '<br>';echo '<br>';
                                    }
                                    ?>
                                    <br>
